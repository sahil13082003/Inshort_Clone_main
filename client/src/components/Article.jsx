...
/**
 * Grid Component to make responsive just read documentation for more details
 * our screen is devided into 12 parts and we adjust what to show and what not easily by grid
 */
